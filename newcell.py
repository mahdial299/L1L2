...
def ban():
    ...
    print(f'''{C+pyfiglet.figlet_format("NEWCELLMEDIA")}
{R+splitter+W}''')
    ...
    while True:
        ...
        match userCh:
            ...
            case 1:
                ...
                # ================= data
                df_CC2 = pd.read_excel(megalobox, sheet_name=CC2_sh_D)
            ...
            case 2: 
                ...
                # ================= data
                df_RD2 = pd.read_excel(megalobox, sheet_name=RD2_sh_D)
            ...
            case 3:
                ...
                # ==================== data
                df_CC3 = pd.read_excel(megalobox, sheet_name=CC3_sh_D)
            ...
            case 4:
                ...
                # ==================== data
                df_RD3 = pd.read_excel(megalobox, sheet_name=RD3_sh_D)
            ...
            case 5:
                ...
                # ==================== data
                df_RD4 = pd.read_excel(megalobox, sheet_name=RD4_sh_D)
